...
message += "Confirmados: " + df_final["Confirmed"].astype(str) + "<br>"
message += "Muertes: " + df_final["Deaths"].astype(str) + "<br>"
message += "Recuperados: " + df_final["Recovered"].astype(str) + "<br>"
message += "Última Actualización: " + df_final["Last_Update"].astype(str)
...
fig.add_trace(
    go.Scattergeo(
        ...
        marker = dict(
            ...
            colorbar_title="Casos Confirmados<br>Última Actualización",  
            colorbar_x = -0.05
        )
...
fig.update_layout(
    ...
    title = "Casos Globales de COVID (Última Actualización: " + str(df_final["Last_Update"][0]) + ")",
    showlegend=True,
